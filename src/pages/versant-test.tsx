...
import versantData from "@/templates/versant.json";
...
export function VersantTest() {
  ...
  const sections = versantData.sections as Section[];
      ...
      <nav className="relative z-10 border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="flex h-16 items-center px-4 sm:px-6">
          ...
          <div className="flex flex-1 items-center justify-between">
            <div>
              <h1 className="text-lg font-semibold">Versant™ Test Practice</h1>
